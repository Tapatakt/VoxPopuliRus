...
UPDATE Language_RU_RU
SET Text = 'Забирайте соседние ничейные клетки того же типа при расширении границ и до 4 клеток при получении города. Можете выбирать награды из древних руин. Юниты получают +20% [ICON_STRENGTH] боевой мощи в пределах 2 клеток от своих стоянок.'
