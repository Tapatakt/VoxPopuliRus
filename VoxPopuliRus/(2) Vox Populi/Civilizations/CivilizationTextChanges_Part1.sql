...
UPDATE Language_RU_RU
SET Text = 'Уникальная кельтская замена для {TXT_KEY_BUILDING_CIRCUS}. В дополнение к бонусам {TXT_KEY_BUILDING_CIRCUS}, {TXT_KEY_BUILDING_CEILIDH_HALL} даёт больше [ICON_CULTURE] Культуры и более длительный день «Мы любим короля», а также генерирует [ICON_CULTURE] Культуру и [ICON_PEACE] Веру. Также содержит слот Музыканта.[NEWLINE][NEWLINE]Каждое уникальное кельтское пантеонное верование дополнительно усиливает это здание.'
...
UPDATE Language_RU_RU
SET Text = 'Когда вы завершаете ветвь общественных институтов, принимаете новые верования или выбираете свою первую Идеологию, получаете 1 [COLOR_POSITIVE_TEXT]бесплатную[ENDCOLOR] Технологию. +1 [ICON_PEACE] Веры от стратегических ресурсов.'
